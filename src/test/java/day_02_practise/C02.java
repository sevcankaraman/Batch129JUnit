...
public class C02 {
    public static void main(String[] args) throws InterruptedException {
        ...
        String sonucc=sonuc.replaceAll("\\D","");// bu kısımda noktalardan kurtulduk
        if (Integer.parseInt(sonucc)>100000000){// ıntegera donusturduk
            System.out.println("sonuc sayısı 100000000 dan fazla");
        }else{
            System.out.println("sonuc sayısı 100000000 dan fazla değil");
        }
